...
käyttöliittymä rakentaa graaffisen ikkunan ja kutsuu graphicslogicia piirtämään graafiset elemntit. Käyttöliittymä käynnistää myös pelilogiikan screen-olion pelilogiikkakerroksesta ja asettaa näppäimistökuuntelija olion keylistener ohjelmistolle.

Pelilogiikka siajitsee snakegame.domain pakkauksessa, ui pakkauksessa on käyttöliittymäluokka Ui ja grafiikan piirtämisen toteuttava luokka GraphicsLogic ja main pakkaus sisältää pääohjelman.
